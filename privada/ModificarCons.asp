...
<head>
   ...
   <title>PIDIRECT - Modificar Respuesta de Consulta</title>
...
if (id="ok") then
  ...
  sSQL= "update consultas set fechaRespuesta=#"&Now()&"#,txtRespuesta='"&resp&"' where id="&cons&""
...
<br><table border="0" width="50%" align="center">
	<tr>
		<td align="center" colspan="2"><img src="../imagenes/modificarCons.jpg"></td>
	</tr>
	<form action="ModificarCons.asp" method="GET" name="FormModCons" onsubmit="return EnviaFormModCons();">
...
<%
  ...
  sSQL = "select * from BuscarConsultas where id="&cons&""
  ...
  if NOT Rs.EOF then
    ...
    Response.Write("</tr>")
    Response.Write("<td><b>LO QUE RESPONDIÓ:</b></td>")
    Response.Write("<td>"&resp&"</td>")
    Response.Write("</tr>")
  end if
...
%>
	<tr>
		<td><b>NUEVA RESPUESTA:</b></td>
		<td><textarea name="respuesta" rows="3" cols="45"></textarea></td>
	</tr>
        <tr><td align="center" colspan="2"><button type="submit" style="font-size:18">Modificar Respuesta</button></tr>
</form></table>
